...
<head>
    ...
    <title>Furniture Store| Quên Mật Khẩu</title>
    ...
    <div class="breadcrumbs py-4">
        <div class="container text-left">
            <ul class="bread-list d-inline-block">
                ...
                <li class="d-inline-block text-capitalize"><a href="fogot-pass.html">Quên mật khẩu</a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="h-100 d-flex align-items-center">
                        <form class="m-0 p-5 text-center" action="confirm-pass.html">

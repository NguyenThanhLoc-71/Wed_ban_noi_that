...
<head>
    ...
    <title>Furniture Store| Xác Nhận Mật Khẩu</title>
    ...
    <div class="breadcrumbs py-4">
        <div class="container text-left">
            <ul class="bread-list d-inline-block">
                ...
                <li class="d-inline-block text-capitalize"><a href="fogot-pass.html">Quên mật khẩu<i class="ti-arrow-right mx-2"></i></a></li>
                <li class="d-inline-block text-capitalize"><a href="confirm-pass.html">Xác nhân mật khẩu</a></li>
            </ul>
        </div>
    </div>
                ...
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="h-100 d-flex align-items-center">
                        <form class="m-0 p-5 text-center">
                            ...
                            <span class="shotcut">
                                <a class="mr-3" href="login.html">Đăng nhập?</a>

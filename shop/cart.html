...
<head>
    ...
    <title>Furniture Store| Giỏ Hàng</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-7 col-12">
                        <div class="text-left">
                            <ul>
                                <li><i class="ti-headphone-alt"></i>0357992113</li>
                                <li><i class="fa fa-envelope-o"></i>support@furniturestore</li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            ...
                                            <a class="cart-img" href="#"><img src="../images/tủ/tủ quần áo gỗ 3790.png" alt="#" /></a>
                                            <h4><a href="#">Tủ quần áo gỗ </a></h4>
                                            <p class="quantity">
                                                1x - <span class="amount">3,790,000đ<</span>
                                            </p>
                                        </li>
                                        ...
                                        <li>
                                            <a href="#" class="remove" title="Remove this item"><i class="fa fa-remove"></i></a>
                                            <a class="cart-img" href="#"><img src="../images/ghế/ghế sofa 11790.png" alt="#" /></a>
                                            <h4><a href="#">Ghế sofa</a></h4>
                                            <p class="quantity">
                                                1x - <span class="amount">11,790,000đ<</span>
                                            </p>
                                        </li>
                                    </ul>
                                    <div class="bottom text-center">
                                        <div class="total">
                                            <span>Tổng cộng</span>
                                            <span class="total-amount">15,580,000đ</span>
                                        </div>
    ...
    <div class="breadcrumbs py-4">
        <div class="container text-left">
            <ul class="bread-list d-inline-block">
                ...
                <li class="d-inline-block text-capitalize"><a href="cart.html">Giỏ hàng</a></li>
            </ul>
        </div>
    </div>
                ...
                <tbody>
                    <tr>
                        <td class="image" data-title="No">
                            <img src="../images/tủ/tủ tivi 2690.png" alt="#" />
                        </td>
                        <td class="product-des" data-title="Description">
                            <p class="product-name">
                                <a href="product-details.html">Tủ Kệ Tivi Gỗ MOHO OSLO 201</a>
                            </p>
                            <p class="product-des">
                    ...
                    <tr>
                        ...
                        <td class="product-des" data-title="Description">
                            ...
                            <p class="product-des">Tiêu chuẩn California Air Resources Board xuất khẩu Mỹ, đảm bảo gỗ không độc hại, an toàn cho sức khỏe
                            </p>
                        </td>
                        <td class="price text-center" data-title="Price">
                            <span>2,690,000đ</span>
            ...
            <div class="total-amount">
                <div class="row">
                    <div class="col-lg-6 col-md-4 col-12">
                        <p class="last">Tổng trị giá<span>8,070,000đ</span></p>
                    </div>
                    <div class="col-lg-3 col-md-4 col-12">
                        <a href="index.html" class="btn cont">Tiếp tục mua</a>
                    </div>
                    <div class="col-lg-3 col-md-4 col-12">
                        <a href="checkout.html" class="btn buy">Mua hàng</a>
                    </div>
                </div>
            </div>
        </div>

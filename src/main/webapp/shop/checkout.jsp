...
<head>
    ...
    <title>Furniture Store| Thanh Toán</title>
    ...
    <div class="breadcrumbs py-4">
        <div class="container text-left">
            <ul class="bread-list d-inline-block">
                ...
                <li class="d-inline-block text-capitalize"><a href="cart.html">Giỏ hàng<i class="ti-arrow-right mx-2"></i></a></li>
                <li class="d-inline-block text-capitalize"><a href="checkout.html">Thanh toán</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="order-details">
                        ...
                        <div class="single-widget mb-4">
                            ...
                            <div class="content mt-3">
                                <ul>
                                    <li>Hóa đơn<span>9,990,000đ</span></li>
                                    <li>(+) Vận chuyển<span>10,000đ</span></li>
                                    <li>Tổng<span class="total">10,000,000đ</span></li>
                                </ul>
                            </div>
                        </div>
                        <!-- Order Widget -->
